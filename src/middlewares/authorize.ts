...
export const authorize =
    ...
    catchAsync(async (req: Request, _res: Response, next: NextFunction) => {
        ...
        const permissions =
            ...
            getEffectivePermissions({ role, permissions: req.user?.permissions as string[] });
        ...
        if (role === USER_ROLE.STAFF && hasAnyPermission(permissions, requiredPermissions)) {
            return next();
        }

        throw new AppError(status.FORBIDDEN, "You do not have permission for this action");
    });
